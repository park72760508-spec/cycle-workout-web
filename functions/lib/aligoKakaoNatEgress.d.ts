...
export declare const ALIGO_KAKAO_NAT_REGION: "asia-northeast3";
/**
...
export declare const ALIGO_KAKAO_CLOUD_FUNCTIONS_VPC_EGRESS_OPTS: AligoKakaoCloudFunctionVpcEgressOpts;
/**
 * VPC+NAT 출구 진단용 공인 IPv4 (카카오톡 API 허용 IP 대조용; 알리고 kakaoapi와 동일 egress일 가능성이 큼).
 */
export declare function fetchAligoKakaoEgressPublicIpDiagnostics(): Promise<string | null>;
export declare function warnIfDiagPublicIpMismatch(seen: string | null | undefined, expectedRaw: string, logTag: string): void;
