...
규칙: 워크아웃 선정은 author에 Z1/Z2/Z3/Z3~Z4/Z4/Z5 표기가 포함된 후보만(카테고리명 "VO2 Max" 텍스트 매칭 금지). selectedCategory는 표시용, 실제 필터는 Zone. workoutId 3개 모두 다름. reason 각 60자 이내. condition_score 55~95(5단위, 100금지). coach_comment 120자·categoryReason 60자 이내. 마크다운·백틱 금지.
{
