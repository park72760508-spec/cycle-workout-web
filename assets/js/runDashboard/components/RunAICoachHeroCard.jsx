/**
 * RunAICoachHeroCard - AI 컨디션 분석 Hero 섹션
...
(function() {
  ...
  if (!window.React) {
    console.warn('[RunAICoachHeroCard] React not loaded');
    return;
  }
  ...
  function RunAICoachHeroCard(props) {
    var p = props || {};
  ...
  window.RunAICoachHeroCard = RunAICoachHeroCard;
})();
