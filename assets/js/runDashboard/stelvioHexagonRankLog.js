/**
 * STELVIO 헥사곤 6축·종합(포지션 점수) — Firestore hexagon_rank_log 동기화
 * - `heptagon_cohort_ranks`: 서버 일괄 집계(전원 순위·이웃/탑 쿼리)
 * - `hexagon_rank_log/{uid}`: 대시보드가 마지막으로 캐시한 본인 요약(merge)
 */
/* global window */
(function () {
  'use strict';
   ...
   */
  function hexagonGetFirestoreDb(mod) {
  ...
  /** `scheduledPeak28dHexagonOnly`가 쓰는 문서 ID — 이웃 표 집계 순위용 */
  /**
  ...
  function hexagonCohortDocId(monthKey, filterCategory, filterGender, userId) {
   ...
   */
  function getStelvioHexagonCohortEntry(o) {
    o = o || {};
    if (!o.userId) {
    ...
    return import(FIRESTORE_MOD_URL)
      .then(function (mod) {
        ...
        return hexagonGetFirestoreDb(mod).then(function (db) {
          if (!db) return { __cohortErr: 'no-firestore' };
          var id = hexagonCohortDocId(o.monthKey, o.filterCategory, o.filterGender, o.userId);
      ...
      .catch(function (e) {
        if (typeof console !== 'undefined' && console.warn) {
          console.warn('[getStelvioHexagonCohortEntry]', e && e.message ? e.message : e);
        }
   ...
   */
  function saveStelvioHexagonRankLog(p) {
    ...
    return import(FIRESTORE_MOD_URL)
      ...
      .catch(function (e) {
        if (typeof console !== 'undefined' && console.warn) {
          console.warn('[hexagon_rank_log]', e && e.message ? e.message : e);
        }
        return false;
      });
  }
   ...
   */
  function queryStelvioHexagonRankTop(o) {
    o = o || {};
    ...
    return import(FIRESTORE_MOD_URL)
      ...
      .catch(function (e) {
        if (typeof console !== 'undefined' && console.warn) {
          console.warn('[queryStelvioHexagonRankTop]', e && e.message ? e.message : e);
        }
  ...
  /**
   * 헥사곤 팝업: 동일 월·필터에서 **환산 점수 합** 높은 순(1,2,3…). 랭킹보드와 동일 집계 소스.
   * 인덱스: filterCategory, filterGender, monthKey, sumPositionScores desc
   * @param {{ monthKey: string, filterCategory: string, filterGender: string, limit?: number }} o
   */
  function queryStelvioHexagonCohortBySumDesc(o) {
    o = o || {};
    var monthKey = o.monthKey != null ? String(o.monthKey) : monthKeyKst();
    var filterCategory = o.filterCategory != null ? String(o.filterCategory) : 'Supremo';
    var filterGender = o.filterGender != null ? String(o.filterGender) : 'all';
    ...
    return import(FIRESTORE_MOD_URL)
      ...
      .catch(function (e) {
        if (typeof console !== 'undefined' && console.warn) {
          console.warn('[queryStelvioHexagonCohortBySumDesc]', e && e.message ? e.message : e);
        }
        return { ok: false, items: [], error: String(e && e.message ? e.message : e) };
      });
  }
   ...
   */
  function queryStelvioHexagonCohortBoardN(o) {
    o = o || {};
    var monthKey = o.monthKey != null ? String(o.monthKey) : monthKeyKst();
    var filterCategory = o.filterCategory != null ? String(o.filterCategory) : 'Supremo';
    var filterGender = o.filterGender != null ? String(o.filterGender) : 'all';
    return import(FIRESTORE_MOD_URL)
      ...
      .catch(function (e) {
        if (typeof console !== 'undefined' && console.warn) {
          console.warn('[queryStelvioHexagonCohortBoardN]', e && e.message ? e.message : e);
        }
   ...
   * @returns {Promise<{ ok: boolean, exists?: boolean, data?: object|null, error?: string }>}
   */
  function getStelvioHexagonRankLog(userId) {
    if (!userId) {
      return Promise.resolve({ ok: false, data: null, error: 'no-uid' });
    }
    return import(FIRESTORE_MOD_URL)
      ...
      .catch(function (e) {
        if (typeof console !== 'undefined' && console.warn) {
          console.warn('[getStelvioHexagonRankLog]', e && e.message ? e.message : e);
        }
        return { ok: false, data: null, error: String(e && e.message ? e.message : e) };
      });
  }

  window.saveStelvioHexagonRankLog = saveStelvioHexagonRankLog;
  /**
   ...
   */
  function queryStelvioHexagonSumNeighbors(o) {
    o = o || {};
    ...
    return import(FIRESTORE_MOD_URL)
      ...
      .catch(function (e) {
        if (typeof console !== 'undefined' && console.warn) {
          console.warn('[queryStelvioHexagonSumNeighbors]', e && e.message ? e.message : e);
        }
        return { ok: false, above: [], below: [], error: String(e && e.message ? e.message : e) };
      });
  }

  window.getStelvioHexagonRankLog = getStelvioHexagonRankLog;
  window.queryStelvioHexagonSumNeighbors = queryStelvioHexagonSumNeighbors;
  window.queryStelvioHexagonRankTop = queryStelvioHexagonRankTop;
  window.queryStelvioHexagonCohortBySumDesc = queryStelvioHexagonCohortBySumDesc;
  window.queryStelvioHexagonCohortBoardN = queryStelvioHexagonCohortBoardN;
  window.getStelvioHexagonRankLogCollectionName = function () {
    return COL;
  };
  window.getStelvioHexagonCohortCollectionName = function () {
    return COL_COHORT;
  };
  window.getStelvioHexagonCohortEntry = getStelvioHexagonCohortEntry;
  window.hexagonCohortDocId = hexagonCohortDocId;
