...
(function () {
  ...
  function registerOpenRidingInit() {
    ...
    window.initOpenRidingRoomReact = async function () {
      ...
      try {
        await import('./openRiding/openRidingBoot.js?v=create-delete-sync-fix-20260803v4');
      } catch (bootErr) {
  ...
  async function loadRunJournalBundle() {
    ...
    await appendScript('assets/js/runJournal/RunJournalYearlyChart.jsx', 'text/babel');
