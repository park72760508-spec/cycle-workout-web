        ...
        <div class="user-header">
          ...
          <div class="user-row1">
            ...
            <div class="user-actions" onclick="event.stopPropagation();">
              ${showDashboardBtn ? `<button class="btn-dashboard" onclick="event.stopPropagation();showPerformanceDashboard('${user.id}')" title="대시보드 보기"><img src="assets/img/data-analytics.png" alt="대시보드" width="20" height="20" loading="lazy" decoding="async" style="width:20px;height:20px;display:block;" /></button>` : ''}
