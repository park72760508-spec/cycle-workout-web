  ...
  function DashboardDetailTabs(props) {
    ...
    return React.createElement(
      ...
      React.createElement(
        'div',
        {
          className: 'sticky top-0 z-10 bg-gray-50 pb-3 pt-0 w-full grid grid-cols-4 gap-2 items-stretch stelvio-detail-tabs'
        },
        tabs.map(function(tab, i) {
          ...
          return React.createElement(
            'button',
            {
              ...
              className:
                'stelvio-detail-tab-btn w-full min-w-0 px-1 py-2.5 text-[11px] sm:text-xs text-center leading-tight transition-all duration-200 rounded-[10px] ' +
                (isActive
