  ...
  if (refXVal != null && selectedXIndex != null && data[selectedXIndex]) {
    ...
    monthPowerStelvioTopPanel = (
      ...
      >
        ...
        >
          <div style={{ fontSize: 13, fontWeight: 700, color: PP_REF_LINE, lineHeight: 1.15, WebkitFontSmoothing: 'antialiased', fontVariantNumeric: 'tabular-nums', whiteSpace: 'nowrap' }}>
