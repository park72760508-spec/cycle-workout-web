...
// ANT+ 채널 설정
// 대부분의 ANT+ USB 수신기는 하드웨어적으로 최대 8개 채널(0-7)을 지원합니다
// 채널 0번은 스캔용으로 사용하므로, 실제 디바이스 연결은 채널 1-7번만 사용 가능 (최대 7개 디바이스)
const ANT_CHANNEL_CONFIG = {
  MAX_CHANNELS: 7, // 최대 동시 연결 채널 수 (스캔 채널 0번 제외, 1-7번 사용)
  SCAN_CHANNEL: 0, // 스캔용 채널 번호
  MIN_CHANNEL: 1, // 사용 가능한 최소 채널 번호
  MAX_CHANNEL: 7 // 사용 가능한 최대 채널 번호 (하드웨어 제한: 8개 채널 중 스캔 채널 제외)
};
